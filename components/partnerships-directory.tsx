...
export function PartnersDirectory({ partners, paginationMeta, companies, events, users, initialPartnerId, currentUserId }: PartnersPageProps) {
            ...
            <div className="flex min-h-0 flex-1 flex-col">
              <div className="min-h-0 flex-1 min-w-0 overflow-x-hidden overflow-y-auto px-5 py-5">
                <form id="partner-edit-form" onSubmit={submitUpdate} className="space-y-4">
                  ...
                  <DirectorCheckboxes users={users} selectedIds={selected.directors.map((director) => director.id)} currentUserId={currentUserId} />
                </form>
